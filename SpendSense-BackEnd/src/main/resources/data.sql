...
INSERT INTO user_account (email,username,first_name,last_name,date_of_birth,password) VALUES ('dummyUser01@email.com',
'dummyUser01','Sam','Smith','1995-08-11','$2a$12$wOv.h5eRmnQY0pKhnP9GNegVt0xJRV0KgsD7w2yQKliX/qQA7wY9O');
INSERT INTO user_account (email,username,first_name,last_name,date_of_birth,password) VALUES ('dummyUser02@email.com',
'dummyUser02','Tony','Stark','1996-04-21','$2a$12$IrP.YECyun.ruDsuy2xeu.LIoAV6kWbaRdM493P5fAItUe09m.foa');
...
INSERT INTO user_transactions (id,amount,remarks,recurring,transaction_date,last_updated,user_account_id,category_id) VALUES (
UUID(),4000.00, 'Salary',false,'2025-08-31',NOW(),1,11);
INSERT INTO user_transactions (id,amount,remarks,recurring,transaction_date,last_updated,user_account_id,category_id) VALUES (
